...
class Env:
    ...
    def __init_env(self):
        ...
        self.file_name = 'time_slot_trend'
    ...
    def hour_reader(self):
        ...
        self.rush_hour_task_number = data.iloc[:, 1:]
        self.id_column = data.iloc[:, 0]  # get the first column
    ...
    def reset(self,save_data_row):
        ...
        slots_str = self.rush_hour_task_number.iloc[save_data_row]
